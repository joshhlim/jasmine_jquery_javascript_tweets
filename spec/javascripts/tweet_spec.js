describe('Tweet', function() {
  beforeEach(function(){
    ...
    badTweet = new Tweet("twitter twitter twitter t.co.","fuck");
  })
  ...
  it("replaces all instances of 'twitter' with 'tweety' and 't.co' with 'Can't go to this site.'", function() {
    expect(badTweet.content).toBe("tweety tweety tweety Can't go to this site..")
  });
